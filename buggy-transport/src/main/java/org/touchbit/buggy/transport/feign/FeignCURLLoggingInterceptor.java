...
package org.touchbit.buggy.transport.feign;
 ...
 */
public class FeignCURLLoggingInterceptor implements RequestInterceptor {
    ...
    public void apply(final RequestTemplate requestTemplate) {
        ...
        final String msg = "Playback curl:\n" + InterceptorHelper.getCurl(method, url, headers, body);
