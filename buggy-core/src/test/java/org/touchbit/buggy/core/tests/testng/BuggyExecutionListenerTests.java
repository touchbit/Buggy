...
import static org.touchbit.buggy.core.model.Type.SMOKE;
...
class BuggyExecutionListenerTests extends BaseUnitTest {
    ...
    void unitTest_20180921183228() {
        BuggyExecutionListener listener = new BuggyExecutionListener(TEST_LOGGER, TEST_LOGGER, TEST_LOGGER);
        ITestResult iTestResult = getMockITestResult(1);
        BuggyExecutionListener.setSteps(new ArrayList<String>() {{
            add("steppp");
        }});
        listener.onTestFinish(iTestResult);
    }
...
//        Type configType = BuggyConfig.getTypes();
//        boolean isForceRun = BuggyConfig.isForce();
//        try {
//            BuggyConfig.setTypes(MODULE);
//            BuggyConfig.setForce(false);
...
//        } finally {
//            BuggyConfig.setType(configType);
...
//        Type configType = BuggyConfig.getType();
//        boolean isForceRun = BuggyConfig.isForceRun();
//        try {
//            BuggyConfig.setType(MODULE);
...
//            BuggyConfig.setPrintCause(false);
//            BuggyConfig.setPrintLog(false);
//            BuggyExecutionListener listener = new BuggyExecutionListener(TEST_LOGGER, TEST_LOGGER, TEST_LOGGER) {
//                @Override
//                protected Suite getSuite(ITestNGMethod method) {
//                    return suite;
...
//            BuggyConfig.setPrintSuite(false);
